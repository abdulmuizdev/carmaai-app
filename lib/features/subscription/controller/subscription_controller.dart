...
class SubscriptionController extends PurchaseController {
  ...
  Future<void> syncSubscriptionStatus() async {
    ...
    PurchasesConfiguration configuration = Platform.isIOS
        ? PurchasesConfiguration("appl_ZNhrDjGsdyVAnwAmpYRrOjoJaAm")
...
extension CustomerInfoAdditions on CustomerInfo {
  ...
  DateTime? getLatestTransactionPurchaseDate() {
    ...
    // TODO: IMP. Must be tested properly. this check
    if (allPurchaseDates.entries.isEmpty ||
        allPurchaseDates.values.any((value) => value == null)) {
      return null;
    }
